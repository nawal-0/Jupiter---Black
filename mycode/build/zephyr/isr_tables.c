...
struct _isr_table_entry __sw_isr_table _sw_isr_table[91] = {
	...
	{(const void *)0x8003dd9, (ISR)0x8000e71}, /* 6 */
	{(const void *)0x8003dd7, (ISR)0x8000e71}, /* 7 */
	{(const void *)0x8003dd5, (ISR)0x8000e71}, /* 8 */
	{(const void *)0x8003dd3, (ISR)0x8000e71}, /* 9 */
	{(const void *)0x8003dd1, (ISR)0x8000e71}, /* 10 */
	...
	{(const void *)0x8003dcf, (ISR)0x8000e71}, /* 23 */
	...
	{(const void *)0x8003dcd, (ISR)0x8000e71}, /* 40 */
