...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_PERIODIC_INTERVAL_MAX, 0x2000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_SYNC_SET, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_RESERVE_MAX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_ADV_AUX_SYNC_OFFSET, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TICKER_LAZY_GET, 1);
